This is a Streamlit application that uses [SimplyGoPy](https://github.com/TheDJVG/SimplyGoPy) to calculate the total amount spent for a set of transactions in a given date range. 
